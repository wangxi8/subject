...
option = {
    title : {
         text: obj.name+'风电、水电、总输出功率预测曲线图',
        x:'center',
    y:'top',
...
option2 = {
    title : {
         text: obj.name+'实际风电、水电、总输出功率曲线图',
        x:'center',
    y:'top',
...
myChart.connect([myChart, myChart2]);
myChart2.connect([myChart2, myChart]);
...
ttimee=1;
   ...
   var Index01=new Array(<?php echo $wind;?>);
    ...
    var Index11=new Array(<?php echo $wind2;?>);
     var Index22=new Array(<?php echo $hydro2?>);
     var Index33=new Array(<?php echo $combined2?>);
var timeTicket;
...
timeTicket = setInterval(function (){
  ...
  option.series[2].data.push(Index03[ttimee]);
      ...
      option2.series[0].data.push(Index11[ttimee]);
  option2.series[1].data.push(Index22[ttimee]);
  option2.series[2].data.push(Index33[ttimee]);
